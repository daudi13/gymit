...
const Benefit = ({
  title, icon, description, setSelectedPage
}: Props) => {
  return (
    <motion.div className='mt-5 rounded-md border-gray-100 md:w-1/3 border-2 px-5 py-16 text-center' variants={childVariant}>
